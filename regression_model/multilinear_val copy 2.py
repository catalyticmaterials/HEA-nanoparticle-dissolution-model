...
initial_params = np.append(np.arange(-3,4)/3,np.zeros(8*7))
...
for train_index,test_index in loo.split(features):
    ...
    def metal_constrain(params):
        return [params[7+ i*8 + metal_idx] for i in range(7)]
...
# plt.tight_layout()
plt.savefig('loocv_parity_eV_copy2.png',dpi=600,bbox_inches='tight')
...
# plt.tight_layout()
plt.savefig('loocv_parity_V_copy2.png',dpi=600,bbox_inches='tight')
