...
plt.savefig('binary/profiles/Pt75Cu25_initial.png',dpi=600,bbox_inches='tight')



final_particle, dissolved_atoms = dissolver.dissolve_atoms_batch(0.8,relax_func=dissolver.relax_particle_batch_cn,traj_file='binary/trajectories/Pt75Cu25.traj')
...
plt.savefig('binary/profiles/Pt75Cu25_final.png',dpi=600,bbox_inches='tight')
...
plt.savefig('binary/Pt25Cu75_initial.png',dpi=600,bbox_inches='tight')



final_particle, dissolved_atoms = dissolver.dissolve_atoms_batch(0.8,relax_func=dissolver.relax_particle_batch_cn,traj_file='binary/trajectories/Pt25Cu75.traj')
final_layer_compositions, final_n_atoms_layer = dissolver.composition_by_layer(final_particle,n_layers=5)


binary_layer_profile(final_layer_compositions,final_n_atoms_layer,0.75,'Cu','Pt')
plt.savefig('binary/profiles/Pt25Cu75_final.png',dpi=600,bbox_inches='tight')
...
plt.savefig('binary/PtRu_initial.png',dpi=600,bbox_inches='tight')



final_particle, dissolved_atoms = dissolver.dissolve_atoms_batch(0.8,relax_func=dissolver.relax_particle_batch_cn,traj_file='binary/trajectories/PtRu.traj')
final_layer_compositions, final_n_atoms_layer = dissolver.composition_by_layer(final_particle,n_layers=5)
...
plt.savefig('binary/profiles/PtRu_final.png',dpi=600,bbox_inches='tight')
...
plt.savefig('binary/profiles/PdRu_initial.png',dpi=600,bbox_inches='tight')



final_particle, dissolved_atoms = dissolver.dissolve_atoms_batch(0.8,relax_func=dissolver.relax_particle_batch_cn,traj_file='binary/trajectories/PdRu.traj')
final_layer_compositions, final_n_atoms_layer = dissolver.composition_by_layer(final_particle,n_layers=5)

print(dissolver.get_composition(final_particle.get_chemical_symbols())[1])

binary_layer_profile(final_layer_compositions,final_n_atoms_layer,0.75,'Pd','Ru')
plt.savefig('binary/profiles/PdRu_final.png',dpi=600,bbox_inches='tight')
...
plt.savefig('binary/profiles/AuPd_initial.png',dpi=600,bbox_inches='tight')



final_particle, dissolved_atoms = dissolver.dissolve_atoms_batch(0.8,relax_func=dissolver.relax_particle_batch_cn,traj_file='binary/trajectories/AuPd.traj')
final_layer_compositions, final_n_atoms_layer = dissolver.composition_by_layer(final_particle,n_layers=5)

print(dissolver.get_composition(final_particle.get_chemical_symbols())[1])

binary_layer_profile(final_layer_compositions,final_n_atoms_layer,0.75,'Pd','Au')
plt.savefig('binary/profiles/AuPd_final.png',dpi=600,bbox_inches='tight')