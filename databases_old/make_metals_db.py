...
with connect('metals_dissolution.db') as db:
	for metal,a in zip(('Ir','Pd','Pt','Rh','Ru'),lattice_parameters):
		...
		db.write(T1_rm,metal=metal,surface='T111',defect='removed')
		db.write(T1_add,metal=metal,surface='T111',defect='add')
		...
		db.write(T2_rm,metal=metal,surface='T100',defect='removed')
		db.write(T2_add,metal=metal,surface='T100',defect='add')
		...
		db.write(E_rm,metal=metal,surface='edge',defect='removed')
		db.write(E_add,metal=metal,surface='edge',defect='add')
		...
		db.write(K_rm,metal=metal,surface='kink',defect='removed')
