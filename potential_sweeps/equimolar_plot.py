...
for subspace in ('','_PGM','_GPGM'):

    U,fd,fd_se,std = np.loadtxt(f'equimolar{subspace}_potential_sweep.csv',delimiter=',',skiprows=1).T
    ...
    plt.savefig(f'equimolar{subspace}_sweep.png',dpi=600,bbox_inches='tight')
