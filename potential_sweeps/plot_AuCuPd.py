...
data = np.loadtxt('AuCuPd_potential_sweep.csv',delimiter=',',skiprows=1)
...
plt.savefig('AuCuPd_Ucrit.png',dpi=600,bbox_inches='tight')
...
fd_data = np.loadtxt('AuCuPd_potential_sweep_fd.csv',delimiter=',',skiprows=1)
...
plt.savefig(f'AuCuPd_Ucrit_fd.png',dpi=600,bbox_inches='tight')
...
plt.savefig(f'AuCuPd_max_Ucrit_fd.png',dpi=600,bbox_inches='tight')