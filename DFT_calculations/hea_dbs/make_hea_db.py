...
np.random.seed(42)
fs = np.random.dirichlet(alpha=np.ones(8), size=N)
...
for idx,f in enumerate(fs):
    ...
    with connect('hea_dbs/T111_HEA.db') as db:
        ...
        del T111_remove[40]
        db.write(T111_remove,slab_idx=idx,metal='none',defect='vacancy')
        ...
        for metal in metals:
            ...
            db.write(T111_add,slab_idx=idx,metal=metal,defect='adatom')
    ...
    with connect('hea_dbs/T100_HEA.db') as db:
        ...
        del T100_remove[40]
        db.write(T100_remove,slab_idx=idx,metal='none',defect='vacancy')
        ...
        for metal in metals:
            ...
            db.write(T100_add,slab_idx=idx,metal=metal,defect='adatom')
    ...
    with connect('hea_dbs/Edge_HEA.db') as db:
        ...
        E_remove = deepcopy(E)
        del E_remove[1]
        db.write(E_remove,slab_idx=idx,metal='none',defect='vacancy')
        ...
        for metal in metals:
            ...
            db.write(E_add,slab_idx=idx,metal=metal,defect='adatom')             
    ...
    with connect('hea_dbs/Kink_HEA.db') as db:
        ...
        K_remove = deepcopy(K)
        del K_remove[2]
        db.write(K_remove,slab_idx=idx,metal='none',defect='vacancy')
