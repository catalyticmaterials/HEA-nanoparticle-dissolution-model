...
with connect('metals_dissolution_4x4.db') as db:
	for metal,a in zip(('Ag','Au','Cu','Ir','Pd','Pt','Rh','Ru'),lattice_parameters):

		# Terrace 111
		T1 = fcc111(metal, (4,4,5),a=a, vacuum=10)
		constraint = FixAtoms(indices=range(48))
		...
		# Terrace 100
		T2 = fcc100(metal,(4,4,5),a=a,vacuum=10)
		...
		# Edge
		E = fcc211(metal,(3,4,5),a=a,vacuum=10)
		constraint = FixAtoms(indices=range(24,60))
		...
		# Kink
		K = fcc211(metal,(3,4,5),a=a,vacuum=10)
