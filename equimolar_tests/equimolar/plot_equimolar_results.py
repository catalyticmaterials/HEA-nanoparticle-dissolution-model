...
data = np.loadtxt('equimolar/equimolar4nm_muM_results.csv',delimiter=',',skiprows=1)
...
plt.tight_layout()
plt.savefig('equimolar/Equimolar4nm_111_compositions.png',dpi=600,bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('equimolar/Equimolar4nm_diss_compositions.png',dpi=600,bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(f'equimolar/Equimolar4nm_Sd.png',dpi=600,bbox_inches='tight')
