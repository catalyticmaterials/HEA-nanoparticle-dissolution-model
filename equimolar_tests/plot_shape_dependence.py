...
data = np.loadtxt('shape_dependence.csv',delimiter=',',skiprows=1)
...
plt.savefig('shape_dependence_111_comp.png',dpi=600)
...
# plt.minorticks_off()
plt.subplots_adjust(top=0.9)
plt.savefig('shape_dependence_diss_comp.png',dpi=600)
...
# plt.tight_layout()
plt.savefig('sd_shape_dependence.png',dpi=600,bbox_inches='tight')
