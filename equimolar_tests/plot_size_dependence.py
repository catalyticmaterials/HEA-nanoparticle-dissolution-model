...
data = np.loadtxt('size_dependence.csv',delimiter=',',skiprows=1)
...
plt.savefig('size_dependence_111_comp.png',dpi=600)
...
# plt.minorticks_off()
plt.subplots_adjust(top=0.9)
plt.savefig('size_dependence_diss_comp.png',dpi=600)
...
plt.minorticks_off()
# plt.tight_layout()
plt.savefig('sd_size_dependence.png',dpi=600,bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('size_error_sample.png',dpi=600)
...
plt.tight_layout()
plt.savefig('size_error_sample_Sd.png',dpi=600)